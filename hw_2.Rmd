...
precision_nnet <- posPredValue(test_set$y, test_set$pred_nnet)
precision_glm <- posPredValue(test_set$y, test_set$pred_glm)
recall_knn <- sensitivity(test_set$y, test_set$pred_knn)
recall_rf <- sensitivity(test_set$y, test_set$pred_rf)
recall_nnet <- sensitivity(test_set$y, test_set$pred_nnet)
recall_glm <- sensitivity(test_set$y, test_set$pred_glm)
